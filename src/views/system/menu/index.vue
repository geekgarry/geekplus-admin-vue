<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="组件" align="center" width="130" show-overflow-tooltip>
        <template slot-scope="scope">
          {{ scope.row.component }}
        </template>
      </el-table-column>
      <el-table-column class-name="status-col" label="状态" align="center" width="65" show-overflow-tooltip>
        <template slot-scope="scope">
          <!-- <el-tag :type="scope.row.status | statusFilter">{{ scope.row.status }}</el-tag> -->
          <span>{{scope.row.status==0?'正常':'停用'}}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" prop="createTime" label="创建时间" width="110" show-overflow-tooltip>
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item v-if="form.menuType != 'B'" label="显示状态">
          ...
          <el-col :span="12">
            <el-form-item v-if="form.menuType == 'M'" label="是否缓存">
